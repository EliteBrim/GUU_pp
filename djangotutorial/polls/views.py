...
def get_nocodb_data(request):
    ...
    url = "https://app.nocodb.com/api/v2/tables/m5mavwi66vkxo4i/records"
    headers = {
        "xc-token": "xoEHB97qbNHr55lkeRDh0XJXqC1TtnvR1RDyIrjg",  # Замените на ваш API-ключ
    }
...
class DataViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        url = "https://app.nocodb.com/api/v2/tables/m5mavwi66vkxo4i/records"
        headers = {
            "xc-token": "xoEHB97qbNHr55lkeRDh0XJXqC1TtnvR1RDyIrjg",
        }
